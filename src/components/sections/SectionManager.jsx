...
import { Plus, FolderOpen, Folder, Edit2, Trash2, ChevronRight, ChevronDown, Download } from 'lucide-react';
    ...
    <div className="space-y-2">
      ...
      <div className="space-y-1">
        <button
          ...
          className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-colors ${selectedSection === null
                    ...
                    <Draggable key={section.id} draggableId={section.id} index={index}>
                      {(provided, snapshot) => (
                        <div
                          ...
                          className={`group flex items-center gap-1 rounded-lg text-sm transition-colors py-2 cursor-grab active:cursor-grabbing ${isSelected
                            ? 'bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300'
                            : snapshot.isDragging
